...
- (instancetype)init {
    ...
    self.layer.borderColor = [UIColor colorWithWhite:0.865 alpha:1.000].CGColor;//图片线框的颜色
...
- (instancetype)init {
    ...
    _replyButton.centerX = self.width *0.6;
    ...
    _retweetButton.centerX = self.width *0.75;
    ...
    _favoriteButton.right = self.width-10;
...
- (instancetype)init {
    ...
    _avatarView.layer.cornerRadius =_avatarView.size.width/2;
...
- (void)setLayout:(T1StatusLayout *)layout {
    ...
    _statusView.topLine.backgroundColor = [UIColor groupTableViewBackgroundColor];//cell分割线颜色
