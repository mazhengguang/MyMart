...
#define kT1CellPadding 12//左右两边边距
#define kT1CellInnerPadding 10//cell的边距
#define kT1CellExtendedPadding 30
#define kT1AvatarSize 48//头像大小
#define kT1ImagePadding 10//头像到内容之间距离
#define kT1ConversationSplitHeight 25
#define kT1ContentLeft (kT1CellPadding + kT1AvatarSize + kT1CellInnerPadding)//内容左边的总宽度
#define kT1ContentWidth (kScreenWidth - 2 * kT1CellPadding - kT1AvatarSize - kT1CellInnerPadding)//内容的宽度
#define kT1QuoteContentWidth (kT1ContentWidth - 2 * kT1CellPadding)
#define kT1ActionsHeight 10
#define kT1TextContainerInset 10
