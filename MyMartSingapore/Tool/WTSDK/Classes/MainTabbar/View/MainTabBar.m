...
- (void)SetupWriteButton{
    ...
    [writeButton setImage:[UIImage imageNamed:@"icon_tabbar_subscription~iphone"] forState:0];
//    [writeButton setBackgroundImage:[UIImage imageNamed:@"icon_tabbar_subscription~iphone"] forState:UIControlStateNormal];
